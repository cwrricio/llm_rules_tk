-- Minimal Snort 3 configuration for the self-contained pipeline.
--
-- Mirrors the essentials of the real testbed's snort.lua (HOME_NET/EXTERNAL_NET
-- 'any', an ips block that includes the rules tree, and alert_fast to file). The
-- generated rule is deployed by the real IDSRuleInjector into
-- rules/temp/rules_farmer_ai.rules, which is pulled in via rules/all.rules below.
--
